# keras does not include a way to calculate f2 score, so I used a script I found on Kaggle to help calculate this
# Credit Sergey Malyutin
# Script Source:  https://www.kaggle.com/malyutins/keras-f2-score

from keras import backend as K


def f_score(y_true, y_pred, threshold=0.1, beta=1.5):
